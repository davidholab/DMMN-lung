...
parser.add_argument( "--model_path", nargs="?", type=str, default="models/DMMN-lung.pkl")
parser.add_argument( "--out_path", nargs="?", type=str, default="imgs/DMMN-lung", help="Path of the output segmap")
args = parser.parse_args()

### Lung pretrained model segmentation classes ###
# Solid: red
# Micropapillary: magenta
# Cribriform: orange
# STAS: yellow
# Acinar: green
# Papillary: cyan
...
def test():
    ...
    n_classes = 15 # the number of tissue subtype classes + 1
